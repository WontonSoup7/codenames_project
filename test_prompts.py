...
def gen_clue(red_words, blue_words, neutral_words, assassin_word):
    ...
    prompt = """
        ...
        CIVILIAN WORDS={neutral_words},
        ASSASSIN={assassin_word}.
        MAXIMIZE RED TEAM'S CHANCES OF WINNING AND MINIMIZE BLUE TEAM'S CHANCES OF WINNING.
        THE CLUE MUST BE STRONGLY RELATED TO RED WORDS AND BE THROUGHOULY UNRELATED TO ALL BLUE WORDS, CIVILIAN WORDS, AND ESPECIALLY THE ASSASSIN WORD. 
